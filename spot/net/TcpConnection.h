...
#ifndef SPOT_NET_TCPCONNECTION_H
#define SPOT_NET_TCPCONNECTION_H
...
namespace spot
{
	namespace net
	{
		...
		class TcpConnection : spot::utility::NonCopyable,
		...
		private:
			...
			void bindSendInLoop(const string& message);
...
#endif  // SPOT_NET_TCPCONNECTION_H
