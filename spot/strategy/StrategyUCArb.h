#ifndef SPOT_STRATEGY_STRATEGYBTCARB_H
#define SPOT_STRATEGY_STRATEGYBTCARB_H
...
namespace spot {
    namespace strategy {
        ...
        class StrategyUCArb : public StrategyCircuit {
        public:
        ...
        private:
            StrategyUCArb(int strategyID, StrategyParameter *params);
