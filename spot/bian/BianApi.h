#ifndef __Bian_API_H__
#define __Bian_API_H__
#include <string>
...
#ifdef __TESTMODE__
#define Bian_DOMAIN "testnet.binancefuture.com"
#else
#define Bian_DOMAIN "fapi.binance.com"
...
public:
	BianApi() {};
	BianApi(string api_key, string secret_key,string customer_id, AdapterCrypto* adapt);
	~BianApi();	
	void Init();
	...
	int CancelOrder(string& symbol, string &order_id, int type = 0);
	int CancelAllOrders();
